...
- 系统要求：评测机支持大部分主流系统（如 windows 、armbian）。
...
在 [criyle/go-judge](https://github.com/criyle/go-judge/releases/) 处下载对应系统架构的 go-judge，并运行（监听 5050端口）。
...
特别地，windows 的配置文件处于 C:/Users/用户名/.hydro 目录下。
